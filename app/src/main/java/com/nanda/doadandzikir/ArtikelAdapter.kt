...
class ArtikelAdapter(private val listArtikel : ArrayList<Artikel>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.imgArtikel.setOnClickListener{
            ...
            intent.putExtra(DetailArtikelActivity.DATA_DESC, listArtikel[position].titleArtikel)
            intent.putExtra(DetailArtikelActivity.DATA_IMAGE, listArtikel[position].titleArtikel)
